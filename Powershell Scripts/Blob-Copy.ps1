...
[int]$ThreadCount = 75
#Storage Variables. 
$StorageAccName = "fisinvoicearchivetstne" # storage account name
$subscriptionID = "7605d4fa-63af-4e50-8328-147b4ae78040" # storage account subscription id
$StorageRGname = "invoice-archive-tst-ne-rg" # storage account RG name.

#SP Details
$azureAppId = "33e6d55b-47fc-4d9a-9312-be43cc3f845c" # SP App ID
$azureAppIdPasswordFilePath = "VVr7Q~llcvDd9QHAN3ZXLAdx5pT6fASWqcS8s" # SP Secret
$tenantId = "54cc0dd4-1f08-454f-8055-66227c421fb6" # tenant ID


$SecPw = convertto-securestring -AsPlainText -Force -String $azureAppIdPasswordFilePath
$azureAppCred = New-Object System.Management.Automation.PSCredential $azureAppId, $SecPw
...
#Get storage context and feed to func.
$Keyfetch = Get-AzStorageAccountKey -ResourceGroupName $StorageRGname -Name $StorageAccName | Select -First 1 | Select -ExpandProperty Value
$Context = New-AzStorageContext -StorageAccountName $StorageAccName -StorageAccountKey $Keyfetch
